  ...
  useEffect(() => {
          ...
          if(refresh){
           setContextData({...contextData, loading : true});
            axios.get("user/inventory/archive-out")
            .then((res) => {
        ...
        <section class="p-4 space-y-5">
          <div style={{ height: '95vh', width: '100%' }}>
            <DataGrid
              ...
              columns={columns.map((item) => Object.assign(item, { headerClassName : 'bg-blue-darker text-white'}))}
...
export default InventoryArchiveOut;
